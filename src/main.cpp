...
uint256 hashGenesisBlock("0x2246e65a1326933f48e22e04ec666e827fa40bbedb5ba31f443a52c2d445dc01");
...
{
    // CashhCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // CashhCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2246e65a1326933f48e22e04ec666e827fa40bbedb5ba31f443a52c2d445dc01");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is gonna be CashhCoin on Cashhcoin.com";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c9630a4874de9341d5e755fead8ed26c2f0ed6078f223c93213b62fc394eaa2ce87e49c2ec06557edc9c41620345a0afc164b60182ef4a6bf1c382b97c11f713") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1480072494;
	    ...
	    assert(block.hashMerkleRoot == uint256("0x5d321595cab4a509f4e6c8eb655c4ad9390c00d6a4b325c14801b318fdcdcd33"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CashhCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CashhCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CashhCoinMiner(CWallet *pwallet)
{
    printf("CashhCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("CashhCoin-miner");
    ...
    try { loop {
        ...
        printf("Running CashhCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CashhCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CashhCoinMiner, pwallet));
}
