...
static const int64 MAX_MONEY = 2510000000 * COIN; // CashhCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 3) / 250; // CashhCoin: Priority cutoff is 2 CashhCoin day / 250 bytes.
    }
